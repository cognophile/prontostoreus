...
/**
 * CompanyFurnishingRatesFixture
 *
 */
class CompanyFurnishingRatesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'company_furnishing_rates_ibfk_1' => ['type' => 'foreign', 'columns' => ['company_id'], 'references' => ['companies', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'company_furnishing_rates_ibfk_2' => ['type' => 'foreign', 'columns' => ['furnishing_id'], 'references' => ['furnishings', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
